...
<body>
	...
	<div id="menuWrap">
		<div id="wrap">
			<ul id="topMenu">
				<li class="topMenuLi pr_123"><a href="">음식소개</a>
				<li class="topMenuLi pr_123"><a href="">트레이닝</a>
				<li class="topMenuLi pr_123"><a href="">커뮤니티</a>
				<li class="topMenuLi pr_123"><a href="">SHOP</a>
			</ul>
		</div>
	</div>
